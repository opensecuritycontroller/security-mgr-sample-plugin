...
alter table SECURITY_GROUP add constraint if not exists SECURITYGROUP_NAME UNIQUE (name);

alter table SECURITY_GROUP_INTERFACE add constraint if not exists SECURITYGROUPINTERFACE_NAME UNIQUE (name);
